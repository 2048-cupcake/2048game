...
function caption(exp) {
  var caption = [];
  caption[2]    = 'balloon candy';
  caption[4]    = 'circle candy';
  caption[8]    = 'royal icing';
  caption[16]   = 'cane candy';
  caption[32]   = 'christmas candy cane';
  caption[64]   = 'Christmas candy';
  caption[128]  = 'lollipop candy';
  caption[256]  = 'sweet candy';
  caption[512]  = 'worst candy';
  caption[1024] = 'spangler candy';
  caption[2048] = 'bulk candy';
