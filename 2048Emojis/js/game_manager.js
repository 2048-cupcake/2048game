...
function caption(exp) {
  var caption = [];
  caption[2]    = 'smiley';
  caption[4]    = 'smiling eyes';
  caption[8]    = 'happy emoji';
  caption[16]   = 'smile face';
  caption[32]   = 'joke';
  caption[64]   = 'Peaceful Smiley Face';
  caption[128]  = 'heart eye emoji';
  caption[256]  = 'kiss emoji';
  caption[512]  = 'Sunglasses Emoji';
  caption[1024] = 'Human Heart';
  caption[2048] = 'heart';
