...
function caption(exp) {
  var caption = [];
  caption[2]    = 'Hamburger Chicken Sandwich';
  caption[4]    = 'Bacon clubhouse burger';
  caption[8]    = 'Veg burger';
  caption[16]   = 'Cheeseburger';
  caption[32]   = 'el primo burger';
  caption[64]   = 'Big mac price';
  caption[128]  = 'korea burger';
  caption[256]  = 'Double grilled chicken burger';
  caption[512]  = 'Hamburger with vegetable';
  caption[1024] = 'Big cheese burger';
  caption[2048] = 'Blck burger';
