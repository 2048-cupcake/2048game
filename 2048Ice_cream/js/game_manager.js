...
function caption(exp) {
  var caption = [];
  caption[2]    = 'chocolate ice';
  caption[4]    = 'gelato';
  caption[8]    = 'Hot chocolate';
  caption[16]   = 'baked alaska';
  caption[32]   = 'buttercream';
  caption[64]   = 'milkshake';
  caption[128]  = 'vanilla ice cream with sprinkles';
  caption[256]  = 'whipped cream';
  caption[512]  = 'buttercream';
  caption[1024] = 'parfait';
  caption[2048] = 'eton mess stacks';
