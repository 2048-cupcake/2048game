...
function caption(exp) {
  var caption = [];
  caption[2]    = 'Dog With Bone';
  caption[4]    = 'Illustration';
  caption[8]    = 'Olivia Huynh';
  caption[16]   = 'Darkness';
  caption[32]   = 'Beagle';
  caption[64]   = 'Alsatian';
  caption[128]  = 'Figurine';
  caption[256]  = 'Animal Figure';
  caption[512]  = 'Nyan Pug';
  caption[1024] = 'Blackops';
  caption[2048] = 'Paw Patrol';
