...
function caption(exp) {
  var caption = [];
  caption[2]    = 'unicorn drawing with colour';
  caption[4]    = 'rainbow unicorn crochet unicorn free pattern';
  caption[8]    = 'unicorn with white background';
  caption[16]   = 'cute unicorn flag';
  caption[32]   = 'vtech myla the magical unicorn';
  caption[64]   = 'rainbow build a bear unicorn';
  caption[128]  = 'rainbow colored unicorn';
  caption[256]  = 'breyer unicorns';
  caption[512]  = 'rainbow unicorn';
  caption[1024] = 'spirit animal oracle cards online';
  caption[2048] = 'unicorn background for laptop';
