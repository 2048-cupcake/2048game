...
function caption(exp) {
  var caption = [];
  caption[2]    = 'domestic short-haired cat';
  caption[4]    = 'halloween art disney';
  caption[8]    = 'winnie the pooh';
  caption[16]   = 'Minnie Mouse';
  caption[32]   = 'donald duck daisy';
  caption[64]   = 'mickey mouse black and white minnie';
  caption[128]  = 'valentines day mickey mouse chocolate';
  caption[256]  = 'disney';
  caption[512]  = 'valentines day mickey mouse';
  caption[1024] = 'love';
  caption[2048] = 'Minnie Mouse';
