...
function caption(exp) {
  var caption = [];
  caption[2]    = 'dPagani Huayra BC';
  caption[4]    = 'Ferrari Pininfarina Sergio';
  caption[8]    = 'Aston Martin Valkyrie';
  caption[16]   = 'Bugatti Veyron by Mansory Vivere';
  caption[32]   = '	Lykan Hypersport';
  caption[64]   = 'McLaren P1 LM';
  caption[128]  = 'Lamborghini Veneno Roadster';
  caption[256]  = 'Koenigsegg CCXR Trevita';
  caption[512]  = 'Bugatti Divo';
  caption[1024] = 'Mercedes Benz Maybach Exelero';
  caption[2048] = 'Rolls Royce Sweptail';
