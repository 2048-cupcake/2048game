...
function caption(exp) {
  var caption = [];
  caption[2]    = 'grinch';
  caption[4]    = 'renas do papai noel';
  caption[8]    = 'good morning Merry Christmas';
  caption[16]   = 'navidad';
  caption[32]   = 'cartoon';
  caption[64]   = 'cupcake';
  caption[128]  = 'candy cane';
  caption[256]  = 'gingerbread couple cookies';
  caption[512]  = 'gingerbread man and woman';
  caption[1024] = 'Angel';
  caption[2048] = 'santa claus and reindeer';
