...
HTMLActuator.prototype.addTile = function (tile) {
  ...
  //img.src = "style/img/" + tile.value + ".png";
   img.src = "https://2048-cupcake.github.io/2048game/2048cupcakes16/img/" + tile.value + ".png";
...
HTMLActuator.prototype.scoreTweetButton = function () {
  ...
  tweet.setAttribute("data-url", "https://2048-cupcake.blogspot.com/2022/09/play-online-cupcake-2048-cool-game.html");
  tweet.setAttribute("data-counturl", "https://2048-cupcake.blogspot.com/2022/09/play-online-cupcake-2048-cool-game.html");
  tweet.textContent = "Tweet";

  var text = "I scored " + this.score + "-" + caption(this.level).toUpperCase() + " at 2048cupcakes #2048_cupcakes #2048_cupcakes_Games #2048cupcakes Games";
