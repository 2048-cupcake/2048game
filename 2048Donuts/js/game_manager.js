...
function caption(exp) {
  var caption = [];
  caption[2]    = 'circle donut';
  caption[4]    = 'cnidaria';
  caption[8]    = 'Doughnut Chocolate';
  caption[16]   = 'ciambella';
  caption[32]   = 'Doughnut';
  caption[64]   = 'Doughnut, Baking Cup';
  caption[128]  = 'Doughnut Chocolate cake Food Cream';
  caption[256]  = 'orange donut';
  caption[512]  = 'apple donut';
  caption[1024] = 'Donut King';
  caption[2048] = 'best doughnut in the world';
